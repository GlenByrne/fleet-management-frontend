...
const UpdateVehicleTachoCalibrationModal = () => {
  ...
  const submitHandler: FormEventHandler = async (e) => {
    e.preventDefault();
    updateVehicleTachoCalibrationModalStateVar(false);
    try {
  ...
  return (
    <Modal
      ...
      setModalState={updateVehicleTachoCalibrationModalStateVar}
        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            ...
            <button
              ...
              onClick={() => updateVehicleTachoCalibrationModalStateVar(false)}
              ref={cancelButtonRef}
            >
              Cancel
            </button>
