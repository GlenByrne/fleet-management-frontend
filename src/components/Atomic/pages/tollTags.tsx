...
import TollTagList from '@/components/Atomic/organisms/TollTags/List/TollTagList';
import CreateTollTagModal from '@/components/Atomic/organisms/TollTags/Modal/Create/CreateTollTagModal';
import DeleteTollTagModal from '@/components/Atomic/organisms/TollTags/Modal/Delete/DeleteTollTagModal';
import UpdateTollTagModal from '@/components/Atomic/organisms/TollTags/Modal/Update/UpdateTollTagModal';
import TollTagTemplate from '@/components/Atomic/templates/TollTagTemplate';
import {
  TollTag,
  GetTollTagsQuery,
  UpdateTollTagInput,
