...
import DefectTemplate from '@/components/Atomic/templates/DefectTemplate';
import CreateDefectModal from '@/components/Atomic/organisms/Defects/Modal/Create/CreateDefectModal';
import UpdateDefectModal from '@/components/Atomic/organisms/Defects/Modal/Update/UpdateDefectModal';
import DeleteDefectModal from '@/components/Atomic/organisms/Defects/Modal/Delete/DeleteDefectModal';
import DefectList from '@/components/Atomic/organisms/Defects/List/DefectList';
