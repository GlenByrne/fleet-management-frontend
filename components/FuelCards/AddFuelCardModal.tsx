...
type AddFuelCardModalProps = {
  modalState: boolean;
  setModalState: (status: boolean) => void;
};

const AddFuelCardModal: FC<AddFuelCardModalProps> = ({
  modalState,
  setModalState,
}) => {
  const cancelButtonRef = useRef(null);

  let cardNumber: any, cardProvider: any, depotId: any;
