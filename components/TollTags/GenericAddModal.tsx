...
import { FC, FormEventHandler, Fragment, ReactNode, useRef } from 'react';
import { Dialog, Transition } from '@headlessui/react';
import { useMutation, useQuery } from '@apollo/client';
import { Depot, ModalMutations, SelectObject } from '../../lib/types';
...
const AddModal = <T extends object>({
  ...
  //   const { data, loading, error } = useQuery(mutations.getSelectable);

  //   const [addTollTag] = useMutation(mutations.add, {
  //     refetchQueries: [mutations.get, 'GetTollTags'],
  //   });
